...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('users.store') }}" method="POST" id="create-user-form" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card shadow w-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mb-3 text-center flex-grow-1 d-flex flex-column justify-content-center">
                                <img id="photo-preview" src="{{ asset('images/default-user.png') }}" alt="Profile Preview"
                            ...
                            <div class="form-group mt-auto">
                                ...
                                <div class="mt-2">
                                    <button type="button" id="clear-photo" class="btn btn-outline-danger d-none w-100">
                                        Clear
                                    </button>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $('#photo').on('change', function() {
                ...
                if (file) {
                    ...
                    preview.attr('src', "{{ asset('images/default-user.png') }}");
                    clearBtn.addClass('d-none');
                }
            });
