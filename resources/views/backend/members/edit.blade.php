...
<div class="container-fluid">
    ...
    <form action="{{ route('members.update', $member->id) }}" method="POST" id="edit-member-form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="father_name" id="father_name" class="form-control" value="{{ old('father_name', $member->father_name) }}" required>
            @error('father_name')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" name="dob" id="dob" class="form-control" value="{{ old('dob', $member->dob) }}" required>
            @error('dob')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="whatsapp" id="whatsapp" class="form-control" value="{{ old('whatsapp', $member->whatsapp) }}" required>
            @error('whatsapp')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="alt_no" id="alt_no" class="form-control" value="{{ old('alt_no', $member->alt_no) }}">
            @error('alt_no')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="city" id="city" class="form-control" value="{{ old('city', $member->city) }}" required>
            @error('city')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="pincode" id="pincode" class="form-control" value="{{ old('pincode', $member->pincode) }}" required>
            @error('pincode')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <select name="business" id="business" class="form-control">
                ...
                <option value="Retail" {{ old('business', $member->business) == 'Retail' ? 'selected' : '' }}>Retail</option>
                <option value="Healthcare" {{ old('business', $member->business) == 'Healthcare' ? 'selected' : '' }}>Healthcare</option>
                <option value="Education" {{ old('business', $member->business) == 'Education' ? 'selected' : '' }}>Education</option>
                <option value="Other" {{ old('business', $member->business) == 'Other' ? 'selected' : '' }}>Other</option>
            </select>
            @error('business')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        ...
        <div class="form-group">
            ...
            <input type="text" name="inspirer" id="inspirer" class="form-control" value="{{ old('inspirer', $member->inspirer) }}">
            @error('inspirer')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="cooperation_field" id="cooperation_field" class="form-control" value="{{ old('cooperation_field', $member->cooperation_field) }}">
