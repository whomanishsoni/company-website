...
@section('content')
    ...
    <nav class="relative flex items-center justify-center py-20 bg-cover bg-center"
        ...
        <div class="container mx-auto px-4 relative z-10 text-center">
            ...
            <p class="text-lg text-gray-200 mt-2">Explore how Sahakar Bharati Rajasthan empowers communities through the
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                    ...
                    <p class="text-gray-600 mb-4">
                        We advocate on behalf of Cooperatives to State and Central Governments, RBI, NABARD, NHB, CBDT, NITI
                        Aayog, and other institutions. Our goal is to create a favorable environment for cooperatives to
                        thrive.
                    </p>
                    <a href="#" class="text-blue-600 hover:text-blue-800">Learn More →</a>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                    ...
                    <p class="text-gray-600 mb-4">
                        We promote and undertake research, studies, and surveys in various fields, particularly those
                        related to Cooperative, social, and economic sectors. Our findings drive innovation and progress.
                    </p>
                    <a href="#" class="text-blue-600 hover:text-blue-800">Learn More →</a>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                    ...
                    <p class="text-gray-600 mb-4">
                        We initiate and support projects aimed at improving socio-economic conditions in rural and tribal
                        areas. Our efforts focus on creating sustainable livelihoods and empowering communities.
                    </p>
                    <a href="#" class="text-blue-600 hover:text-blue-800">Learn More →</a>
                </div>
            </div>
