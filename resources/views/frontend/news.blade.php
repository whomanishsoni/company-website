        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <p class="text-gray-600 mb-4">Discover how Sahakar Bharati Rajasthan is empowering small farmers through
                ...
                <!-- News Article 2 -->
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="{{ asset('images/blog-2.jpg') }}" alt="News 2" class="rounded-lg mb-4">
                    <h3 class="text-xl font-semibold mb-2">Women Empowerment Through SHGs</h3>
                    <p class="text-gray-600 mb-4">Learn how Sahakar Bharati Rajasthan is supporting women through self-help
                        groups (SHGs), enabling them to achieve financial independence.</p>
                ...
                <!-- News Article 5 -->
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="{{ asset('images/blog-5.jpg') }}" alt="News 5" class="rounded-lg mb-4">
                    <h3 class="text-xl font-semibold mb-2">Policy Advocacy for Cooperatives</h3>
                    <p class="text-gray-600 mb-4">Learn how Sahakar Bharati Rajasthan is advocating for policy changes to
                        strengthen the cooperative movement and protect its autonomy.</p>
                    <a href="{{ route('news.show', ['id' => 5]) }}" class="text-blue-600 hover:underline">Read More →</a>
                </div>

                <!-- News Article 6 -->
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="{{ asset('images/blog-6.jpg') }}" alt="News 6" class="rounded-lg mb-4">
                    <h3 class="text-xl font-semibold mb-2">Financial Inclusion Initiatives</h3>
                    <p class="text-gray-600 mb-4">Discover how Sahakar Bharati Rajasthan is promoting financial inclusion by
                        providing access to credit and savings for marginalized communities.</p>
